Ext.define('JobOpenings.view.referrals.filtertoolbar.JobReferralsFilterController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.jobreferralsfiltercontroller',
    ...
    onApplyBtnClick: function(btn, e, eOpts) {
        var form = this.getView(),
            ...
            match = locationValue,
            listview = Ext.ComponentQuery.query('jobopeningsreferralslistview'),
            dataview = listview[0].down('dataview[reference="jobdataviewreferrals"]'),
            dataviewStore = dataview.getStore(),
            window = form.up('window'),
            vm=this.getViewModel(),
            tagPanel = Ext.ComponentQuery.query("jobreferralsfilterview"),
