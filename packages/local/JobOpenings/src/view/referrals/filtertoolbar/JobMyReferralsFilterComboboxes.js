Ext.define('JobOpenings.view.referrals.filtertoolbar.JobMyReferralsFilterComboboxes', {
	...
	requires: [
		...
		'JobOpenings.view.referrals.filtertoolbar.JobMyReferralsFilterController',
		'JobOpenings.view.jobopeningrequest.filtertoolbar.FilterViewModel'
	],
	viewModel: 'filterviewmodel',
	controller: 'jobmyreferralsfiltercontroller',
	layout:'column',
	items: [{
		columnWidth: 0.5,
		items: [{
	...
	dockedItems: [{
		...
		items: [{
			...
			listeners: {
				click: 'onApplyBtnClickMyReferrals'
			}
		}, {
			xtype: 'tbfill'
		}]
