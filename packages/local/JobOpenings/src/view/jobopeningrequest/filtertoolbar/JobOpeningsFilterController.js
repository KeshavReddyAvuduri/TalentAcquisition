Ext.define('JobOpenings.view.jobopeningrequest.filtertoolbar.JobOpeningsFilterController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.jobopeningsfiltercontroller',
    ...
    onApplyBtnClick: function(btn, e, eOpts) {
        ...
        var form = this.getView(),
            ...
            match = locationValue,
            listview = Ext.ComponentQuery.query('jobopeningsrequestlistview'),
            dataview = listview[0].down('dataview[reference="jobdataview"]'),
            dataviewStore = dataview.getStore(),
            window = form.up('window'),
            vm=this.getViewModel(),
            tagPanel = Ext.ComponentQuery.query("jobopeningsfilterview"),
